...
Public Class World
    ...
    Public ReadOnly Property Features As IEnumerable(Of IFeature) Implements IWorld.Features
        Get
            Return Data.Features.Keys.Select(Function(x) Feature.Create(Me, Data, x))
        End Get
    End Property
