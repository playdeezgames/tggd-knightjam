...
Friend Class VerbModel
    ...
    Public Sub Perform(itemModel As IItemModel) Implements IVerbModel.Perform
        verb.World.ClearMessages()
        Dim item As IItem = itemModel.GetItem()
        item.World.Avatar.PerformItemVerb(item, verb)
    End Sub
