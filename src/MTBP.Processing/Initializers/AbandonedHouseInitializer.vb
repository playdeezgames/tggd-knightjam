...
Friend Module AbandonedHouseInitializer
    ...
    Private Sub InitializePkasticBag(item As IItem)
        ...
        item.CreateVerb(AddressOf InitializeReachIn)
    End Sub

    Private Sub InitializeReachIn(verb As IVerb)
        verb.SetName("Reach in...")
        verb.SetDescription("I'm sure it'll be fine!")
        verb.SetVerbType(VerbTypes.REACH_IN)
    End Sub
